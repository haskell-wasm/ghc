...
{                                                                            \
    ...
    goto nextInsn;                                                           \
        ...
        case bci_OP_ADD_64: SIZED_BIN_OP(+, StgWord64)
        case bci_OP_SUB_64: SIZED_BIN_OP(-, StgWord64)
        case bci_OP_AND_64: SIZED_BIN_OP(&, StgWord64)
        case bci_OP_XOR_64: SIZED_BIN_OP(^, StgWord64)
        case bci_OP_OR_64:  SIZED_BIN_OP(|, StgWord64)
        case bci_OP_MUL_64: SIZED_BIN_OP(*, StgWord64)
        ...
        case bci_OP_NEG_64: UN_SIZED_OP(-, StgWord64)


        case bci_OP_ADD_32: SIZED_BIN_OP(+, StgWord32)
        case bci_OP_SUB_32: SIZED_BIN_OP(-, StgWord32)
        case bci_OP_AND_32: SIZED_BIN_OP(&, StgWord32)
        case bci_OP_XOR_32: SIZED_BIN_OP(^, StgWord32)
        case bci_OP_OR_32:  SIZED_BIN_OP(|, StgWord32)
        case bci_OP_MUL_32: SIZED_BIN_OP(*, StgWord32)
        ...
        case bci_OP_NEG_32: UN_SIZED_OP(-, StgWord32)


        case bci_OP_ADD_16: SIZED_BIN_OP(+, StgWord16)
        case bci_OP_SUB_16: SIZED_BIN_OP(-, StgWord16)
        case bci_OP_AND_16: SIZED_BIN_OP(&, StgWord16)
        case bci_OP_XOR_16: SIZED_BIN_OP(^, StgWord16)
        case bci_OP_OR_16:  SIZED_BIN_OP(|, StgWord16)
        case bci_OP_MUL_16: SIZED_BIN_OP(*, StgWord16)
        ...
        case bci_OP_NEG_16: UN_SIZED_OP(-, StgWord16)


        case bci_OP_ADD_08: SIZED_BIN_OP(+, StgWord8)
        case bci_OP_SUB_08: SIZED_BIN_OP(-, StgWord8)
        case bci_OP_AND_08: SIZED_BIN_OP(&, StgWord8)
        case bci_OP_XOR_08: SIZED_BIN_OP(^, StgWord8)
        case bci_OP_OR_08:  SIZED_BIN_OP(|, StgWord8)
        case bci_OP_MUL_08: SIZED_BIN_OP(*, StgWord8)
        ...
        case bci_OP_NEG_08: UN_SIZED_OP(-, StgWord8)
